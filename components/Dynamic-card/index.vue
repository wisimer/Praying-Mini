<template>
	<view class="dynamic-card">
		<view class="flex align-center">
			<view class="flex align-center"
				@click.stop="toNextPage(`/subHome/personal/personal?user_id=${userInfo._id}`)">
		...
		<view @click="isTo">
			<view class="font-size30 d-dec">
				...
				<view class="img-box" v-if="dynamicDetail.imgs && dynamicDetail.imgs.length && dynamicDetail.imgs !== ''">
